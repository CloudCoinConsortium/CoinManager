...
TASKID=$(curl 'http://localhost:8888/api/v1/import' -d @<(echo "{\"name\":\"ddd\", \"items\":[{\"type\":\"file\", \"data\":\"/home/alexander/dev/superraida/coins/3358003.cc\"} ]}") 2>/dev/null| jq -r '.payload.id')
